...
class pikaGoogleSync extends pikaActivity { 
	...
	private $RSAKEY = "/var/www/keys/mcplusa_rsakey.pem";
	...
	*/
	...
	public $server_timezone_offset = "-05";
	...
	{				
		...
		$_extprop->setAttribute('value',"http://" . $_SERVER["HTTP_HOST"] . "/pika/");
	...
	public function deleteDoc($data) 
	{
		try {
			if (!empty($data['document_uri'])) {
				...
				$uri = "http://docs.google.com/feeds/default/private/full/".$data['document_uri'].']';
  ...
  function any_base_convert ($numstring, $frombase, $tobase)
  {
